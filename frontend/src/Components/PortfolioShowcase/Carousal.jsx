    ...
    <div style={{ width: '80%', margin: 'auto' }}>
      <Slider {...settings}>
        {stories.map((story, index) => (
          <StoryCard key={index} coverImage ={story.coverImage} title={story.title} content={story.content}/>
        ))}
      </Slider>
    </div>
  );
